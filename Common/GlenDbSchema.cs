...
namespace OpenLoco.Common
{
	...
	public class GlenDBSchema2
	{
		public IList<GlenDbData2> data { get; set; }
	}
	...
	public class GlenDbData2
	{
		...
		[JsonPropertyName("C04")] public string VehicleType { get; set; }
		[JsonPropertyName("C05")] public string Designed { get; set; }
		[JsonPropertyName("C06")] public string Speed { get; set; }
		[JsonPropertyName("C07")] public string Power { get; set; }
		[JsonPropertyName("C08")] public string CargoCapacity1 { get; set; }
		[JsonPropertyName("C09")] public string CargoType1 { get; set; }
		[JsonPropertyName("C10")] public string CargoCapacity2 { get; set; }
		[JsonPropertyName("C11")] public string CargoType2 { get; set; }
		[JsonPropertyName("C12")] public string Creator { get; set; }
		[JsonPropertyName("C13")] public string Checksum { get; set; }
		[JsonPropertyName("C14")] public string _Tags { get; set; }

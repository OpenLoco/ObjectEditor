...
internal record DatTrackObject(
	...
	[property: LocoStructOffset(0x0A), LocoArrayLength(TrackObjectLoader.Constants.MaxMods), LocoStructVariableLoad, Browsable(false)] object_id[] _Mods,
	...
	[property: LocoStructOffset(0x25), LocoArrayLength(TrackObjectLoader.Constants.MaxBridges), Browsable(false)] object_id[] _Bridges,       // 0x25
	[property: LocoStructOffset(0x2C)] uint8_t NumStations,
	[property: LocoStructOffset(0x2D), LocoArrayLength(TrackObjectLoader.Constants.MaxStations), Browsable(false)] object_id[] _Stations,       // 0x2D

...
public record CompanyType1(
	...
	[property: LocoStructOffset(0x8C54), LocoArrayLength(120)] uint32_t[] CargoUnitsDistanceHistory,
	[property: LocoStructOffset(0x8E34)] uint16_t JailStatus,
	[property: LocoStructOffset(0x8E36), LocoArrayLength(0x8FA8 - 0x8E36)] uint8_t[] pad_8E36  // CompanyType1 has extra data here vs CompanyType2
	)
	: ILocoStruct
{

...
namespace OpenLoco.Definitions.DTO.Mappers
{
	...
	{
		public static DtoObjectBridge ToDto(this TblObjectBridge tblobjectbridge)
		{
			return new DtoObjectBridge
			{
		...
		public static TblObjectBridge ToTblObjectBridgeEntity(this DtoObjectBridge model)
		{
			return new TblObjectBridge
			{
				Flags = model.Flags,

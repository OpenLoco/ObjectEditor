...
namespace OpenLoco.Definitions.DTO.Mappers
{
	...
	{
		public static DtoObjectClimate ToDto(this TblObjectClimate tblobjectclimate)
		{
			return new DtoObjectClimate
			{
		...
		public static TblObjectClimate ToTblObjectClimateEntity(this DtoObjectClimate model)
		{
			return new TblObjectClimate
			{

...
{
	public static DtoObjectInterface ToDto(this TblObjectInterface tblobjectinterface) => new()
	{
		...
		WindowPlayerColour = tblobjectinterface.WindowPlayerColour,
		...
		CompanyInfoToolbarColour = tblobjectinterface.CompanyInfoToolbarColour,
		TimeToolbarColour = tblobjectinterface.TimeToolbarColour,
		Id = tblobjectinterface.Id,
	};

	public static TblObjectInterface ToTblObjectInterfaceEntity(this DtoObjectInterface model, TblObject parent) => new()
	{
		Parent = parent,
		...
		WindowPlayerColour = model.WindowPlayerColour,
		...
		CompanyInfoToolbarColour = model.CompanyInfoToolbarColour,

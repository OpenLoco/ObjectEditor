...
namespace OpenLoco.Definitions.DTO.Mappers
{
	...
	{
		public static DtoObjectLand ToDto(this TblObjectLand tblobjectland)
		{
			return new DtoObjectLand
			{
		...
		public static TblObjectLand ToTblObjectLandEntity(this DtoObjectLand model)
		{
			return new TblObjectLand
			{

...
namespace OpenLoco.Definitions.DTO.Mappers
{
	...
	{
		public static DtoObjectTrackSignal ToDto(this TblObjectTrackSignal tblobjecttracksignal)
		{
			return new DtoObjectTrackSignal
			{
		...
		public static TblObjectTrackSignal ToTblObjectTrackSignalEntity(this DtoObjectTrackSignal model)
		{
			return new TblObjectTrackSignal
			{
				Flags = model.Flags,

...
public static class ImageTableNamer
{
	...
	class InterfaceSkinObjectNamer : ImageTableNamer<InterfaceSkinObject>
	{
		...
		static readonly Dictionary<int, string> ImageIdNameMap = new()
		{
			...
			{ 472, "blueprint-copy" },
			{ 473, "blueprint-paste" },
			{ 474, "blueprint-frame-0" },
			{ 475, "blueprint-frame-1" },
			{ 476, "blueprint-frame-2" },
			{ 477, "blueprint-frame-3" },
			{ 478, "blueprint-frame-4" },
			{ 479, "blueprint-frame-5" },
			{ 480, "blueprint-frame-6" },
			{ 481, "blueprint-frame-7" },
			{ 482, "blueprint-frame-8" },
			{ 483, "blueprint-frame-9" },
			{ 484, "blueprint-frame-10" },
			{ 485, "blueprint-frame-11" },
			{ 486, "blueprint-frame-12" },
			{ 487, "blueprint-frame-13" },
			{ 488, "blueprint-frame-14" },
			{ 489, "blueprint-frame-15" },
		};
	}

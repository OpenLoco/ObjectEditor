...
namespace OpenLoco.Definitions.SourceData
{
	...
	//public record ExpandedTblLookup<T, TPack>(T Object, ICollection<TblAuthor> Authors, ICollection<TblTag> Tags, ICollection<TPack> Packs);
	public record ExpandedTblLookup<T, U, TPack>(T Object, ICollection<U> Lookups, ICollection<TblAuthor> Authors, ICollection<TblTag> Tags, ICollection<TPack> Packs);

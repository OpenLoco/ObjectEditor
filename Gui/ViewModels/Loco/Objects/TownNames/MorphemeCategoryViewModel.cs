...
{
	[Description("[0-255] Controls chance to skip / bias selection. When bias is 0, chance to select from N morphemes is 1/N. With bias B, change is 1/(N+B). Chance of skipping entirely is added and is also 1/(N+B). In other words, adding a bias adds B chances to skip entirely.")]

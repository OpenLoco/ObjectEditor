...
namespace OpenLoco.Gui.ViewModels
{
	public class MainWindowViewModel : ViewModelBase
	{
		...
		public async Task LoadSingleObject()
		{
			...
			if (Model.TryLoadObject(new FileSystemItemBase(fsi.Filename, Path.GetFileName(fsi.Filename), fsi.UniqueName, createdTime, modifiedTime, FileLocation.Local), out var uiLocoFile) && uiLocoFile != null)
			{
				...
				var fsi2 = new FileSystemItemBase(fsi.Filename, uiLocoFile!.DatFileInfo.S5Header.Name, fsi.UniqueName, createdTime, modifiedTime, FileLocation.Local, source);

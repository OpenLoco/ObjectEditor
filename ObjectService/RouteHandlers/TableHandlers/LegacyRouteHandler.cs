...
namespace ObjectService.RouteHandlers.TableHandlers
{
	...
	public class LegacyRouteHandler()
	{
		...
		public async Task<IResult> GetDat([FromQuery] string datName, [FromQuery] uint datChecksum, [FromQuery] bool? returnObjBytes, LocoDbContext db, [FromServices] ILogger<LegacyRouteHandler> logger, [FromServices] IServiceProvider sp)
		{
		...
		public async Task<IResult> GetObjectImages(DbKey uniqueObjectId, LocoDbContext db, [FromServices] ILogger<LegacyRouteHandler> logger, [FromServices] IServiceProvider sp)
		{
		...
		public async Task<IResult> GetObject([FromQuery] int uniqueObjectId, [FromQuery] bool? returnObjBytes, LocoDbContext db, [FromServices] ILogger<LegacyRouteHandler> logger, [FromServices] IServiceProvider sp)
		{
		...
		async Task<IResult> ReturnObject(bool? returnObjBytes, ILogger<LegacyRouteHandler> logger, ExpandedTbl<TblObject, TblObjectPack>? eObj, ServerFolderManager sfm)
		{
		...
		public async Task<IResult> GetDatFile([FromQuery] string datName, [FromQuery] uint datChecksum, LocoDbContext db, [FromServices] IServiceProvider sp)
		{
		...
		public async Task<IResult> GetObjectFile([FromQuery] int uniqueObjectId, LocoDbContext db, [FromServices] IServiceProvider sp)
		{
			var obj = await db.DatObjects
				.Include(x => x.Object)
		...
		IResult ReturnFile(TblObject? obj, (string objectName, uint checksum)? datDetails, ulong? xxHash3, ServerFolderManager sfm)
		{
			if (obj == null)
			{
				return Results.NotFound();
		...
		public async Task<IResult> ListScenarios([FromServices] IServiceProvider sp)
			=> await Task.Run(() =>
			{
				var sfm = sp.GetRequiredService<ServerFolderManager>();
		...
		public async Task<IResult> GetScenario([FromQuery] int uniqueScenarioId, [FromQuery] bool? returnObjBytes, LocoDbContext db, [FromServices] ILogger<LegacyRouteHandler> logger)
		...
		public async Task<IResult> UploadDat(DtoUploadDat request, LocoDbContext db, [FromServices] ILogger<LegacyRouteHandler> logger, [FromServices] IServiceProvider sp)
		{
		...
		public async Task<IResult> UploadObject([FromServices] ILogger<LegacyRouteHandler> logger)
		{
		...
		public async Task<IResult> UpdateDat([FromServices] ILogger<LegacyRouteHandler> logger)
		{
			logger.LogWarning("[UploadDat] - not implemented");
			return await Task.Run(() => Results.Problem(statusCode: StatusCodes.Status501NotImplemented));
		}

		public async Task<IResult> UpdateObject([FromServices] ILogger<LegacyRouteHandler> logger)
		{
			logger.LogWarning("[UploadDat] - not implemented");
			return await Task.Run(() => Results.Problem(statusCode: StatusCodes.Status501NotImplemented));
		}

...
namespace OpenLocoTool.Objects
{
	...
	//	public uint32_t var_0C { get; set; }
	//	public uint16_t AllowedPlaneTypes { get; set; }
	//	public uint8_t NumSpriteSets { get; set; }
	//	public uint8_t NumTiles { get; set; }
	//	public List<uint8_t> var_14 { get; set; }
	//	public List<uint16_t> var_18 { get; set; }
	//	public List<uint8_t> var_1C { get; set; }
	//	public List<uint32_t> var_9C { get; set; }

...
namespace OpenLocoTool.Objects
{
	...
	public record BridgeObject(
		...
		[property: LocoStructOffset(0x03), LocoStructVariableLoad, LocoArrayLength(3), LocoPropertyMaybeUnused, Browsable(false)] uint8_t[] pad_03,
		...
		[property: LocoStructOffset(0x16)] image_id Image,
		[property: LocoStructOffset(0x1A), LocoPropertyMaybeUnused] uint8_t NumCompatibleTrackMods,
		[property: LocoStructOffset(0x1B), LocoStructVariableLoad, LocoArrayLength(7), LocoPropertyMaybeUnused, Browsable(false)] uint8_t[] TrackModHeaderIds,
		[property: LocoStructOffset(0x22), LocoPropertyMaybeUnused] uint8_t NumCompatibleRoadMods,
		[property: LocoStructOffset(0x23), LocoStructVariableLoad, LocoArrayLength(7), LocoPropertyMaybeUnused, Browsable(false)] uint8_t[] RoadModHeaderIds,

...
namespace OpenLocoTool.Objects
{
	...
	public record DockObject(
		...
		//[property: LocoStructOffset(0x14)] const uint8_t* var_14,
		//[property: LocoStructOffset(0x18)] const uint16_t* var_18,
		//[property: LocoStructOffset(0x1C)] const uint8_t* var_1C[1], // odd that this is size 1 but that is how its used

...
namespace Schema.Migrations
{
    ...
    [Migration("20240823151016_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OpenLoco.Schema.Database.TblAuthor", b =>
                {
            ...
            modelBuilder.Entity("OpenLoco.Schema.Database.TblLicence", b =>
                {
            ...
            modelBuilder.Entity("OpenLoco.Schema.Database.TblLocoObject", b =>
                {
            ...
            modelBuilder.Entity("OpenLoco.Schema.Database.TblModpack", b =>
                {
            ...
            modelBuilder.Entity("OpenLoco.Schema.Database.TblTag", b =>
                {
            ...
            modelBuilder.Entity("OpenLoco.Schema.Database.TblLocoObject", b =>
                {
                    b.HasOne("OpenLoco.Schema.Database.TblAuthor", "Author")
                        .WithMany()
                        .HasForeignKey("AuthorTblAuthorId");

                    b.HasOne("OpenLoco.Schema.Database.TblLicence", "Licence")
                        .WithMany()
            ...
            modelBuilder.Entity("TblLocoObjectTblModpack", b =>
                {
                    b.HasOne("OpenLoco.Schema.Database.TblModpack", null)
                        .WithMany()
                        .HasForeignKey("ModpacksTblModpackId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("OpenLoco.Schema.Database.TblLocoObject", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TblLocoObjectTblTag", b =>
                {
                    ...
                    b.HasOne("OpenLoco.Schema.Database.TblTag", null)
                        .WithMany()

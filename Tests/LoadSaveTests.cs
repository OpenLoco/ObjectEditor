...
#pragma warning restore IDE0079 // Remove unnecessary suppression
	...
	{
		static void assertFunc(LocoObject obj, AirportObject struc)
		{
			using (Assert.EnterMultipleScope())
			{
	...
	{
		static void assertFunc(LocoObject obj, BridgeObject struc)
		{
			using (Assert.EnterMultipleScope())
			{
	...
	{
		static void assertFunc(LocoObject obj, BuildingObject struc)
		{
			using (Assert.EnterMultipleScope())
			{
	...
	{
		static void assertFunc(LocoObject obj, CargoObject struc)
		{
			using (Assert.EnterMultipleScope())
			{
	...
	{
		static void assertFunc(LocoObject obj, CliffEdgeObject _)
		{
			using (Assert.EnterMultipleScope())
			{
	...
	{
		static void assertFunc(LocoObject obj, ClimateObject struc)
		{
			using (Assert.EnterMultipleScope())
			{
	...
	{
		static void assertFunc(LocoObject obj, CompetitorObject struc)
		{
			using (Assert.EnterMultipleScope())
			{
	...
	{
		static void assertFunc(LocoObject obj, CurrencyObject struc)
		{
			using (Assert.EnterMultipleScope())
			{
	...
	{
		static void assertFunc(LocoObject obj, DockObject struc)
		{
			using (Assert.EnterMultipleScope())
			{
	...
	{
		static void assertFunc(LocoObject obj, HillShapesObject struc)
		{
			using (Assert.EnterMultipleScope())
			{
	...
	{
		static void assertFunc(LocoObject obj, IndustryObject struc)
		{
			using (Assert.EnterMultipleScope())
			{
	...
	{
		static void assertFunc(LocoObject obj, InterfaceSkinObject struc)
		{
			using (Assert.EnterMultipleScope())
			{
	...
	{
		static void assertFunc(LocoObject obj, LandObject struc)
		{
			using (Assert.EnterMultipleScope())
			{
	...
	{
		static void assertFunc(LocoObject obj, LevelCrossingObject struc)
		{
			using (Assert.EnterMultipleScope())
			{
				...
				Assert.That(struc.TransitionAnimationDelayBitmask, Is.EqualTo(3), nameof(struc.TransitionAnimationDelayBitmask));
	...
	{
		static void assertFunc(LocoObject obj, RegionObject struc)
		{
			using (Assert.EnterMultipleScope())
			{
				Assert.That(struc.VehicleDrivingSide, Is.EqualTo(DrivingSide.Left), nameof(struc.VehicleDrivingSide));
	...
	{
		static void assertFunc(LocoObject obj, RoadExtraObject struc)
		{
			using (Assert.EnterMultipleScope())
			{
	...
	{
		static void assertFunc(LocoObject obj, RoadObject struc)
		{
			using (Assert.EnterMultipleScope())
			{
	...
	{
		static void assertFunc(LocoObject obj, RoadStationObject struc)
		{
			using (Assert.EnterMultipleScope())
			{
	...
	{
		static void assertFunc(LocoObject obj, ScaffoldingObject struc)
		{
			using (Assert.EnterMultipleScope())
			{
	...
	{
		static void assertFunc(LocoObject obj, SnowObject struc)
		{
			using (Assert.EnterMultipleScope())
			{
	...
	{
		static void assertFunc(LocoObject obj, SoundObject struc)
		{
			using (Assert.EnterMultipleScope())
			{
	...
	{
		static void assertFunc(LocoObject obj, SteamObject struc)
		{
			using (Assert.EnterMultipleScope())
			{
	...
	{
		static void assertFunc(LocoObject obj, StreetLightObject struc)
		{
			using (Assert.EnterMultipleScope())
			{
	...
	{
		static void assertFunc(LocoObject obj, TownNamesObject struc)
		{
			using (Assert.EnterMultipleScope())
			{
	...
	{
		static void assertFunc(LocoObject obj, TrackExtraObject struc)
		{
			using (Assert.EnterMultipleScope())
			{
	...
	{
		static void assertFunc(LocoObject obj, TrackObject struc)
		{
			using (Assert.EnterMultipleScope())
			{
				// Bridges
	...
	{
		static void assertFunc(LocoObject obj, TrackSignalObject struc)
		{
			using (Assert.EnterMultipleScope())
			{
	...
	{
		static void assertFunc(LocoObject obj, TrackStationObject struc)
		{
			using (Assert.EnterMultipleScope())
			{
	...
	{
		static void assertFunc(LocoObject obj, TreeObject struc)
		{
			using (Assert.EnterMultipleScope())
			{
	...
	{
		void assertFunc(LocoObject obj, TunnelObject struc)
		{
			Assert.Multiple(() => Assert.That(obj.ImageTable.GraphicsElements, Has.Count.EqualTo(4)));
		}
	...
	{
		static void assertFunc(LocoObject obj, VehicleObject struc)
		{
			using (Assert.EnterMultipleScope())
			{
	...
	{
		static void assertFunc(LocoObject obj, WallObject struc)
		{
			using (Assert.EnterMultipleScope())
			{
	...
	{
		static void assertFunc(LocoObject obj, WaterObject struc)
		{
			using (Assert.EnterMultipleScope())
			{
				Assert.That(struc.CostIndex, Is.EqualTo(2), nameof(struc.CostIndex));

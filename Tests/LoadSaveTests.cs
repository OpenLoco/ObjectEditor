...
#pragma warning restore NUnit2045 // Use Assert.Multiple
		...
		static void LoadSaveGenericTest<T>(string filename, Action<ILocoObject, T> assertFunc) where T : ILocoStruct
		{
			...
			var bytes1 = SawyerStreamWriter.WriteLocoObject(objectName, SourceGame.Vanilla, obj1);

			var (obj2, struc2) = LoadObject<T>(bytes1);
			assertFunc(obj2, struc2);

			var bytes2 = SawyerStreamWriter.WriteLocoObject(objectName, SourceGame.Vanilla, obj2);
